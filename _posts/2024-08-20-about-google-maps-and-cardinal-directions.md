...
## Google Maps when walking

When using Google Maps, it can sometimes be confusing to know which direction to head in to reach your destination. Occasionally, this confusion can lead us in the wrong direction. To avoid this and ensure we always start on the right path, here are a few helpful tips:

1) **Zoom in on the map and verify your starting point**: 
...
3) **Choose an easily identifiable starting point if needed**: 
...
Knowing the cardinal directions in Google Maps is useful for determining which direction you need to head based on your current location (starting point).
